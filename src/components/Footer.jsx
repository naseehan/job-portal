                             ...
                             <div id="mc_embed_signup">
                                 ...
                                 method="get" className="subscribe_form relative mail_part">
                                     ...
                                     <div className="form-icon">
                                         ...
                                         className="email_icon newsletter-submit button-contactForm"><img src={form} alt="" /></button>
                                     </div>
                 ...
                 <div className="row d-flex justify-content-between align-items-center">
                     ...
                     <div className="col-xl-2 col-lg-2">
                         <div className="footer-social f-right">
                             ...
                             <a href="https://twitter.com/i/flow/login?redirect_after_login=%2F"><i className="fab fa-twitter"></i></a>
                             <a href="https://www.bostonglobe.com/"><i className="fas fa-globe"></i></a>
